 ...
 */
class KafkaSource(config: KinesisEnrichConfig, igluResolver: Resolver, enrichmentRegistry: EnrichmentRegistry)
    extends AbstractSource(config, igluResolver, enrichmentRegistry) with Logging {
